...
class PageMetadataExtension extends AbstractExtension
{
    ...
    public function getFunctions(): array
    {
        return [ 
            ...
            new TwigFunction("page_link_canonical", [ $this->helper->getPage(), "getLinkCanonical" ], [ "is_safe" => [ "html" ] ]),
            new TwigFunction("page_link_canonical_lang", [ $this->helper->getPage(), "getLinkCanonicalLang" ], [ "is_safe" => [ "html" ] ]),
            new TwigFunction("page_og_type", [ $this->helper->getPage(), "getOgType" ], [ "is_safe" => [ "html" ] ]),
            new TwigFunction("page_og_url", [ $this->helper->getPage(), "getOgUrl" ], [ "is_safe" => [ "html" ] ]),
